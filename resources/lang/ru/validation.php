...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'size'                  => 'размер',
        'type'                  => 'тип',
        'beds_bases_id'         => 'основание кровати',
        'beds_materials_id'         => 'материал',
        'bed_furniture_sizes_id'         => 'размеры',
        'have_boxes'         => 'наличие ящиков',
        'furniture_storages_furniture_dimensions_id' => 'габариты',
        'age_category' => 'возврастная категория',
        'hardness' => 'жёсткость',
        'mattresses_materials_id' => 'материал',
        'mattresses_furniture_sizes_id' => 'размеры',
        'function' => 'функция',
        'mattress_fastenings_id' => 'крепления',
        'mattress_covers_furniture_sizes_id' => 'размеры',
        'tables_materials_id' => 'материал',
        'tables_furniture_dimensions_id' => 'габариты',
