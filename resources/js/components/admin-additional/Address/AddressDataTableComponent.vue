        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span>Вы действительно хотите удалить данный адрес?</span>
                </div>
    ...
    <div class="col-12">
        <div class="card p-3">
            <DataTable
                ...
                <template #empty><span class="text-secondary">Адреса не найдены!</span></template>
                ...
                <Column>
                    <template #body="slotProps">
                        <div class="d-flex" style="gap: 20px">
                            <a :href='`/admin/addresses/edit/${slotProps.data.id}`'>
...
export default {
    ...
    methods: {
        refresh(){
            this.loading = true;
            axios.get('/api/addresses').then(resp => {
        ...
        deleteSelected(){
            if(this.selectedElement != null){
                axios.post(`/api/addresses/delete/${this.selectedElement.id}`);
